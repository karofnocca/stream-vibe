        ...
        <section className="hero" aria-labelledby={titleId}>
            ...
            <div className="hero__body">
                <div className="hero__pano-inner container">
                    ...
                    id={titleId}>The Best Streaming Experience</h1>
                    <div className="hero__description">StreamVibe is the best streaming experience for watching your favorite movies and shows on demand, anytime, anywhere. With StreamVibe, you can enjoy a wide variety of content, including the latest blockbusters, classic movies, popular TV shows, and more. You can also create your own watchlists, so you can easily find the content you want to watch.</div>
                    <Button 
